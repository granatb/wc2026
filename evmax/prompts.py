...
# FPL-only field vocabulary, spliced into the prompt when unit == "Gameweek".
# The World Cup prompt must not carry it: a model told about p_defcon will look
# for it, and no WC entry has one.
_FPL_GLOSSARY = """\
...
def build_prompt(slug: str, round_no: int, entries: list, subject=None,
    ...
    unit: the reader-facing period word ("Round" or "Gameweek"); "Gameweek" also
          splices in the FPL field glossary.
    """
